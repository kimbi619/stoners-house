        ...
        <div className="container">
            ...
            <div className="addresses">
                <div className="location1">
                    ...
                    <address>Email: <link rel="stylesheet" href="mailto: stonershouseus@gmail.com" />stonershouseofficial@gmail.com</address>
                </div>
                ...
                <div className="location1">
                    ...
                    <address>Address :  1923 Bexley Lane, Chesapeake Virginia 23322, US.</address>
                    <address>Phone : +1-757-762-0455</address>
                    <address>Email: <link rel="stylesheet" href="mailto: stonershousecanada@gmail.com" />stonershouseofficial@gmail.com</address>
                </div>
            </div>
